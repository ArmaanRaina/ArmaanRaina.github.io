...
var instructions_stroop_1 = {
	type: jsPsychHtmlButtonResponse,
	stimulus: `<p style='font-size: 12pt; text-align: left;'>See what color the top word is. Select that color from the two options below. DON'T<br>
				...
				<span style='font-size: 30pt; font-weight: 1000; color: #0000FF;'>RED</span><p><br></p>
	...
	button_html: `<div style='height: 5px;'></div><button class="defaultButton">%choice%</button>`,
	on_finish: function(data) {
		data.task = "stroop";
	}
}
